 ...
 * 
 */
public final class CopyFpGrowth {
   ...
   */
    ...
    int numGroups = params.getInt(CopyFpGrowth.NUM_GROUPS,
    		CopyFpGrowth.NUM_GROUPS_DEFAULT);
  ...
  public static void startAggregating(Parameters params, Configuration conf)
    ...
    job.setJarByClass(CopyFpGrowth.class);
